...
class Skin:
    ...
    def useLeftArm(self):
        ...
        for mission in missions.values():
            self.copyReserveAndPaste(
                self.leftArm, self.rightArm, mission[0], mission[1])
    ...
    def useLeftLeg(self):
        ...
        for mission in missions.values():
            self.copyReserveAndPaste(
                self.leftLeg, self.rightLeg, mission[0], mission[1])
    ...
    def copyReserveAndPaste(self, sourceImage, targetImage, position, size):
        image = self.cropImage(sourceImage, position,
                               size).transpose(Image.FLIP_LEFT_RIGHT)
